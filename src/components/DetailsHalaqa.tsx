  ...
  return (
    <div className="w-full h-[var(--height-screen)] bg-gray-200 grid grid-cols-6 grid-rows-6 gap-4 p-2">
      <div className="col-span-4 row-span-6 flex justify-between items-center flex-col">
        <div className="border-2 rounded-lg w-full p-2 h-full mb-4 ">
        ...
        <button
          ...
          className={`relative text-xl font-bold border-2 rounded-lg w-full text-center p-2 mt-5 cursor-pointer`}
        >
          {notification ? 
            <>
              <span className="absolute flex size-4 justify-center items-center ">
                ...
                <span className="absolute inline-flex size-3 rounded-full bg-primary"></span>
              </span>
              <p>قائمة الطلبات</p>
            </>
            :
